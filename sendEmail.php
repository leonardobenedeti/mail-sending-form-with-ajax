...
if($_POST){
 ...
 $message_body = "Mensagem enviada pelo formulário do meu site"."\r\n\r\n";
 ...
 if(!$send_mail)
 {
   ...
   $output = json_encode(array('type'=>'message', 'text' => 'Olá '.$user_name .', seu email foi enviado.<br/> Obrigado pelo contato. =D'));
   die($output);
 }
}
?>